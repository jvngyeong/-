		...
		<section class="ftco-section">
			<div class="container">
				<div class="row justify-content-center">
					...
					<h3 class="text-center mb-4">변경하실 이름을<br>입력하세요.<br><br><br><br><br><br></h3>
						<form action="name_change_process.php" class="login-form" method="post">
						<div class="form-group">
							이름
							<input type="text" name="name" id="name" class="form-control rounded-left" placeholder="Name" required>
						</div>
					<div class="form-group">
