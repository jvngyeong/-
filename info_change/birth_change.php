		...
		<section class="ftco-section">
			<div class="container">
				<div class="row justify-content-center">
					...
					<h3 class="text-center mb-4">변경하실 생년월일을<br>입력하세요.<br><br><br><br><br><br></h3>
						<form action="birth_change_process.php" class="login-form" method="post">
						<div class="form-group">
                            생년월일
                            <input type="date" id="birth" name="birth" class="form-control rounded-left" placeholder="Birth" required>
                        </div>
					<div class="form-group">
